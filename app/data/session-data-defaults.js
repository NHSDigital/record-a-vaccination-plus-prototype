...
module.exports = {
  ...
  data: [
    "Patients", "Staff", "Site or delivery team", "Assessment and consent", "Vaccination", "NHS number", "Name", "Date of birth", "Address", "Due date", "General practice name"
  ],
  reportChosenVaccines: [
    "Flu", "Pertussis", "Respiratory syncytial virus (RSV)"
  ],
  careHomes: [
